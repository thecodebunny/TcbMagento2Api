...
class SalesInvoiceCommentRepositoryV1Api
{
     ...
     * 
     *
     * @param \TheCodeBunny\Magento2Api\Model\Body76 $body  (optional)
     ...
     * @param \TheCodeBunny\Magento2Api\Model\Body76 $body  (optional)
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return array of \TheCodeBunny\Magento2Api\Model\SalesDataInvoiceCommentInterface, HTTP status code, HTTP response headers (array of strings)
     */
    public function salesInvoiceCommentRepositoryV1SavePostWithHttpInfo($body = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\TheCodeBunny\Magento2Api\Model\SalesDataInvoiceCommentInterface',
                '/V1/invoices/comments'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\TheCodeBunny\Magento2Api\Model\SalesDataInvoiceCommentInterface', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\TheCodeBunny\Magento2Api\Model\SalesDataInvoiceCommentInterface', $e->getResponseHeaders());
