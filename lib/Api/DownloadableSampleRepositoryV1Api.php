...
class DownloadableSampleRepositoryV1Api
{
     ...
     * @param string $sku  (required)
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return array of \TheCodeBunny\Magento2Api\Model\DownloadableDataSampleInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function downloadableSampleRepositoryV1GetListGetWithHttpInfo($sku)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\TheCodeBunny\Magento2Api\Model\DownloadableDataSampleInterface[]',
                '/V1/products/{sku}/downloadable-links/samples'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\TheCodeBunny\Magento2Api\Model\DownloadableDataSampleInterface[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\TheCodeBunny\Magento2Api\Model\DownloadableDataSampleInterface[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\TheCodeBunny\Magento2Api\Model\ErrorResponse', $e->getResponseHeaders());
     ...
     *
     * @param string $sku  (required)
     * @param \TheCodeBunny\Magento2Api\Model\Body106 $body  (optional)
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return int
     */
     ...
     * @param \TheCodeBunny\Magento2Api\Model\Body107 $body  (optional)
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return int
     */
