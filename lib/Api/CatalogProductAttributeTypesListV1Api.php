...
class CatalogProductAttributeTypesListV1Api
{
     ...
     * @return \TheCodeBunny\Magento2Api\Model\CatalogDataProductAttributeTypeInterface[]
     */
     ...
     *
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return array of \TheCodeBunny\Magento2Api\Model\CatalogDataProductAttributeTypeInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function catalogProductAttributeTypesListV1GetItemsGetWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\TheCodeBunny\Magento2Api\Model\CatalogDataProductAttributeTypeInterface[]',
                '/V1/products/attributes/types'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\TheCodeBunny\Magento2Api\Model\CatalogDataProductAttributeTypeInterface[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\TheCodeBunny\Magento2Api\Model\CatalogDataProductAttributeTypeInterface[]', $e->getResponseHeaders());
