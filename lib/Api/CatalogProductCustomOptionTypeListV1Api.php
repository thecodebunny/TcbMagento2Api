...
class CatalogProductCustomOptionTypeListV1Api
{
     ...
     * @return \TheCodeBunny\Magento2Api\Model\CatalogDataProductCustomOptionTypeInterface[]
     */
     ...
     *
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return array of \TheCodeBunny\Magento2Api\Model\CatalogDataProductCustomOptionTypeInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function catalogProductCustomOptionTypeListV1GetItemsGetWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\TheCodeBunny\Magento2Api\Model\CatalogDataProductCustomOptionTypeInterface[]',
                '/V1/products/options/types'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\TheCodeBunny\Magento2Api\Model\CatalogDataProductCustomOptionTypeInterface[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\TheCodeBunny\Magento2Api\Model\CatalogDataProductCustomOptionTypeInterface[]', $e->getResponseHeaders());
