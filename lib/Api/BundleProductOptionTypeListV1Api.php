...
class BundleProductOptionTypeListV1Api
{
     ...
     * @return \TheCodeBunny\Magento2Api\Model\BundleDataOptionTypeInterface[]
     */
     ...
     *
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return array of \TheCodeBunny\Magento2Api\Model\BundleDataOptionTypeInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function bundleProductOptionTypeListV1GetItemsGetWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\TheCodeBunny\Magento2Api\Model\BundleDataOptionTypeInterface[]',
                '/V1/bundle-products/options/types'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\TheCodeBunny\Magento2Api\Model\BundleDataOptionTypeInterface[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\TheCodeBunny\Magento2Api\Model\BundleDataOptionTypeInterface[]', $e->getResponseHeaders());
