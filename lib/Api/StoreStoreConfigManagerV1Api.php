...
class StoreStoreConfigManagerV1Api
{
     ...
     * @return \TheCodeBunny\Magento2Api\Model\StoreDataStoreConfigInterface[]
     */
     ...
     * @param string[] $storeCodes  (optional)
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return array of \TheCodeBunny\Magento2Api\Model\StoreDataStoreConfigInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function storeStoreConfigManagerV1GetStoreConfigsGetWithHttpInfo($storeCodes = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\TheCodeBunny\Magento2Api\Model\StoreDataStoreConfigInterface[]',
                '/V1/store/storeConfigs'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\TheCodeBunny\Magento2Api\Model\StoreDataStoreConfigInterface[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\TheCodeBunny\Magento2Api\Model\StoreDataStoreConfigInterface[]', $e->getResponseHeaders());
