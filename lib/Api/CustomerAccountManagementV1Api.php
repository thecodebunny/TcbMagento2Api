...
class CustomerAccountManagementV1Api
{
     ...
     * 
     *
     * @param \TheCodeBunny\Magento2Api\Model\Body7 $body  (optional)
     ...
     * @param \TheCodeBunny\Magento2Api\Model\Body8 $body  (optional)
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return \TheCodeBunny\Magento2Api\Model\CustomerDataCustomerInterface
     */
     ...
     * 
     *
     * @param \TheCodeBunny\Magento2Api\Model\Body9 $body  (optional)
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return bool
     */
     ...
     * 
     *
     * @param \TheCodeBunny\Magento2Api\Model\Body6 $body  (optional)
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return \TheCodeBunny\Magento2Api\Model\CustomerDataCustomerInterface
     */
     ...
     * 
     *
     * @param \TheCodeBunny\Magento2Api\Model\Body10 $body  (optional)
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return bool
     */
     ...
     * 
     *
     * @param \TheCodeBunny\Magento2Api\Model\Body13 $body  (optional)
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return bool
     */
     ...
     * 
     *
     * @param \TheCodeBunny\Magento2Api\Model\Body11 $body  (optional)
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return bool
     */
     ...
     * 
     *
     * @param \TheCodeBunny\Magento2Api\Model\Body12 $body  (optional)
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return \TheCodeBunny\Magento2Api\Model\CustomerDataValidationResultsInterface
     */
     ...
     * @param \TheCodeBunny\Magento2Api\Model\Body12 $body  (optional)
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return array of \TheCodeBunny\Magento2Api\Model\CustomerDataValidationResultsInterface, HTTP status code, HTTP response headers (array of strings)
     */
    public function customerAccountManagementV1ValidatePutWithHttpInfo($body = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\TheCodeBunny\Magento2Api\Model\CustomerDataValidationResultsInterface',
                '/V1/customers/validate'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\TheCodeBunny\Magento2Api\Model\CustomerDataValidationResultsInterface', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\TheCodeBunny\Magento2Api\Model\CustomerDataValidationResultsInterface', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\TheCodeBunny\Magento2Api\Model\ErrorResponse', $e->getResponseHeaders());
