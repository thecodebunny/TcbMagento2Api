...
class CatalogProductLinkManagementV1Api
{
     ...
     * @param string $type  (required)
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return array of \TheCodeBunny\Magento2Api\Model\CatalogDataProductLinkInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function catalogProductLinkManagementV1GetLinkedItemsByTypeGetWithHttpInfo($sku, $type)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\TheCodeBunny\Magento2Api\Model\CatalogDataProductLinkInterface[]',
                '/V1/products/{sku}/links/{type}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\TheCodeBunny\Magento2Api\Model\CatalogDataProductLinkInterface[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\TheCodeBunny\Magento2Api\Model\CatalogDataProductLinkInterface[]', $e->getResponseHeaders());
     ...
     *
     * @param string $sku  (required)
     * @param \TheCodeBunny\Magento2Api\Model\Body36 $body  (optional)
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return bool
     */
