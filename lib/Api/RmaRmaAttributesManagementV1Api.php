...
class RmaRmaAttributesManagementV1Api
{
     ...
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return \TheCodeBunny\Magento2Api\Model\FrameworkMetadataObjectInterface[]
     */
     ...
     * @param string $dataObjectClassName Data object class name (optional)
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return array of \TheCodeBunny\Magento2Api\Model\FrameworkMetadataObjectInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function rmaRmaAttributesManagementV1GetCustomAttributesMetadataGetWithHttpInfo($dataObjectClassName = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\TheCodeBunny\Magento2Api\Model\FrameworkMetadataObjectInterface[]',
                '/V1/returnsAttributeMetadata/custom'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\TheCodeBunny\Magento2Api\Model\FrameworkMetadataObjectInterface[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\TheCodeBunny\Magento2Api\Model\FrameworkMetadataObjectInterface[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\TheCodeBunny\Magento2Api\Model\ErrorResponse', $e->getResponseHeaders());
