...
class StoreGroupRepositoryV1Api
{
     ...
     * @return \TheCodeBunny\Magento2Api\Model\StoreDataGroupInterface[]
     */
     ...
     *
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return array of \TheCodeBunny\Magento2Api\Model\StoreDataGroupInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function storeGroupRepositoryV1GetListGetWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\TheCodeBunny\Magento2Api\Model\StoreDataGroupInterface[]',
                '/V1/store/storeGroups'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\TheCodeBunny\Magento2Api\Model\StoreDataGroupInterface[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\TheCodeBunny\Magento2Api\Model\StoreDataGroupInterface[]', $e->getResponseHeaders());
