...
class DirectoryCurrencyInformationAcquirerV1Api
{
     ...
     * @return \TheCodeBunny\Magento2Api\Model\DirectoryDataCurrencyInformationInterface
     */
     ...
     *
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return array of \TheCodeBunny\Magento2Api\Model\DirectoryDataCurrencyInformationInterface, HTTP status code, HTTP response headers (array of strings)
     */
    public function directoryCurrencyInformationAcquirerV1GetCurrencyInfoGetWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\TheCodeBunny\Magento2Api\Model\DirectoryDataCurrencyInformationInterface',
                '/V1/directory/currency'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\TheCodeBunny\Magento2Api\Model\DirectoryDataCurrencyInformationInterface', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\TheCodeBunny\Magento2Api\Model\DirectoryDataCurrencyInformationInterface', $e->getResponseHeaders());
