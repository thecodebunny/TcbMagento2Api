...
class SalesRuleCouponManagementV1Api
{
     ...
     * 
     *
     * @param \TheCodeBunny\Magento2Api\Model\Body93 $body  (optional)
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return \TheCodeBunny\Magento2Api\Model\SalesRuleDataCouponMassDeleteResultInterface
     */
     ...
     * @param \TheCodeBunny\Magento2Api\Model\Body93 $body  (optional)
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return array of \TheCodeBunny\Magento2Api\Model\SalesRuleDataCouponMassDeleteResultInterface, HTTP status code, HTTP response headers (array of strings)
     */
    public function salesRuleCouponManagementV1DeleteByCodesPostWithHttpInfo($body = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\TheCodeBunny\Magento2Api\Model\SalesRuleDataCouponMassDeleteResultInterface',
                '/V1/coupons/deleteByCodes'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\TheCodeBunny\Magento2Api\Model\SalesRuleDataCouponMassDeleteResultInterface', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\TheCodeBunny\Magento2Api\Model\SalesRuleDataCouponMassDeleteResultInterface', $e->getResponseHeaders());
     ...
     * 
     *
     * @param \TheCodeBunny\Magento2Api\Model\Body92 $body  (optional)
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return \TheCodeBunny\Magento2Api\Model\SalesRuleDataCouponMassDeleteResultInterface
     */
     ...
     * 
     *
     * @param \TheCodeBunny\Magento2Api\Model\Body91 $body  (optional)
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return string[]
     */
