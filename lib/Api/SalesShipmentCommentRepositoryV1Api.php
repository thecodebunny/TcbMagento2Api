...
class SalesShipmentCommentRepositoryV1Api
{
     ...
     * @param \TheCodeBunny\Magento2Api\Model\Body83 $body  (optional)
     ...
     * @param \TheCodeBunny\Magento2Api\Model\Body83 $body  (optional)
     * @throws \TheCodeBunny\Magento2Api\ApiException on non-2xx response
     * @return array of \TheCodeBunny\Magento2Api\Model\SalesDataShipmentCommentInterface, HTTP status code, HTTP response headers (array of strings)
     */
    public function salesShipmentCommentRepositoryV1SavePostWithHttpInfo($id, $body = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\TheCodeBunny\Magento2Api\Model\SalesDataShipmentCommentInterface',
                '/V1/shipment/{id}/comments'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\TheCodeBunny\Magento2Api\Model\SalesDataShipmentCommentInterface', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\TheCodeBunny\Magento2Api\Model\SalesDataShipmentCommentInterface', $e->getResponseHeaders());
