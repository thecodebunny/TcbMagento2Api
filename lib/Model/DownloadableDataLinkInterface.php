...
class DownloadableDataLinkInterface implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'linkType' => 'string',
        'linkFile' => 'string',
        'linkFileContent' => '\TheCodeBunny\Magento2Api\Model\DownloadableDataFileContentInterface',
        'linkUrl' => 'string',
        'sampleType' => 'string',
        'sampleFile' => 'string',
        'sampleFileContent' => '\TheCodeBunny\Magento2Api\Model\DownloadableDataFileContentInterface',
        'sampleUrl' => 'string',
        'extensionAttributes' => '\TheCodeBunny\Magento2Api\Model\DownloadableDataLinkExtensionInterface'
    ];
     ...
     * @param \TheCodeBunny\Magento2Api\Model\DownloadableDataFileContentInterface $linkFileContent
     * @return $this
     */
     ...
     * @return \TheCodeBunny\Magento2Api\Model\DownloadableDataLinkExtensionInterface
     */
     ...
     * @param \TheCodeBunny\Magento2Api\Model\DownloadableDataLinkExtensionInterface $extensionAttributes
     * @return $this
     */
