...
class SalesDataShipmentTrackCreationInterface implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'extensionAttributes' => '\TheCodeBunny\Magento2Api\Model\SalesDataShipmentTrackCreationExtensionInterface',
        'trackNumber' => 'string',
        'title' => 'string',
        'carrierCode' => 'string'
    ];
     ...
     * @return \TheCodeBunny\Magento2Api\Model\SalesDataShipmentTrackCreationExtensionInterface
     */
     ...
     * @param \TheCodeBunny\Magento2Api\Model\SalesDataShipmentTrackCreationExtensionInterface $extensionAttributes
     * @return $this
     */
