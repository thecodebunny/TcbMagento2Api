# TheCodeBunny\Magento2Api\SalesShipmentTrackRepositoryV1Api
...
$api_instance = new TheCodeBunny\Magento2Api\Api\SalesShipmentTrackRepositoryV1Api();
...
> \TheCodeBunny\Magento2Api\Model\SalesDataShipmentTrackInterface salesShipmentTrackRepositoryV1SavePost($body)
...
$api_instance = new TheCodeBunny\Magento2Api\Api\SalesShipmentTrackRepositoryV1Api();
$body = new \TheCodeBunny\Magento2Api\Model\Body84(); // \TheCodeBunny\Magento2Api\Model\Body84 | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\TheCodeBunny\Magento2Api\Model\Body84**](../Model/\TheCodeBunny\Magento2Api\Model\Body84.md)|  | [optional]

### Return type

[**\TheCodeBunny\Magento2Api\Model\SalesDataShipmentTrackInterface**](../Model/SalesDataShipmentTrackInterface.md)
