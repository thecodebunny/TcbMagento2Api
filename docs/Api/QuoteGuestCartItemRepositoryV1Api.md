# TheCodeBunny\Magento2Api\QuoteGuestCartItemRepositoryV1Api
...
$api_instance = new TheCodeBunny\Magento2Api\Api\QuoteGuestCartItemRepositoryV1Api();
...
> \TheCodeBunny\Magento2Api\Model\QuoteDataCartItemInterface[] quoteGuestCartItemRepositoryV1GetListGet($cartId)
...
> \TheCodeBunny\Magento2Api\Model\QuoteDataCartItemInterface quoteGuestCartItemRepositoryV1SavePost($cartId, $body)
...
$body = new \TheCodeBunny\Magento2Api\Model\Body61(); // \TheCodeBunny\Magento2Api\Model\Body61 | 
...
------------- | ------------- | ------------- | -------------
 **cartId** | **string**|  |
 **body** | [**\TheCodeBunny\Magento2Api\Model\Body61**](../Model/\TheCodeBunny\Magento2Api\Model\Body61.md)|  | [optional]
...
> \TheCodeBunny\Magento2Api\Model\QuoteDataCartItemInterface quoteGuestCartItemRepositoryV1SavePut($cartId, $itemId, $body)
...
$body = new \TheCodeBunny\Magento2Api\Model\Body62(); // \TheCodeBunny\Magento2Api\Model\Body62 | 
 ...
 **cartId** | **string**|  |
 **itemId** | **string**|  |
 **body** | [**\TheCodeBunny\Magento2Api\Model\Body62**](../Model/\TheCodeBunny\Magento2Api\Model\Body62.md)|  | [optional]
