# TheCodeBunny\Magento2Api\GiftCardAccountGuestGiftCardAccountManagementV1Api
...
$api_instance = new TheCodeBunny\Magento2Api\Api\GiftCardAccountGuestGiftCardAccountManagementV1Api();
$cartId = "cartId_example"; // string | 
$body = new \TheCodeBunny\Magento2Api\Model\Body120(); // \TheCodeBunny\Magento2Api\Model\Body120 | 
...
------------- | ------------- | ------------- | -------------
 **cartId** | **string**|  |
 **body** | [**\TheCodeBunny\Magento2Api\Model\Body120**](../Model/\TheCodeBunny\Magento2Api\Model\Body120.md)|  | [optional]
