# TheCodeBunny\Magento2Api\CatalogProductAttributeManagementV1Api
...
$api_instance = new TheCodeBunny\Magento2Api\Api\CatalogProductAttributeManagementV1Api();
$body = new \TheCodeBunny\Magento2Api\Model\Body24(); // \TheCodeBunny\Magento2Api\Model\Body24 | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**\TheCodeBunny\Magento2Api\Model\Body24**](../Model/\TheCodeBunny\Magento2Api\Model\Body24.md)|  | [optional]
...
> \TheCodeBunny\Magento2Api\Model\CatalogDataProductAttributeInterface[] catalogProductAttributeManagementV1GetAttributesGet($attributeSetId)
