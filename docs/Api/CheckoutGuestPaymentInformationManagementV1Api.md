# TheCodeBunny\Magento2Api\CheckoutGuestPaymentInformationManagementV1Api
...
> \TheCodeBunny\Magento2Api\Model\CheckoutDataPaymentDetailsInterface checkoutGuestPaymentInformationManagementV1GetPaymentInformationGet($cartId)
...
$api_instance = new TheCodeBunny\Magento2Api\Api\CheckoutGuestPaymentInformationManagementV1Api();
...
$api_instance = new TheCodeBunny\Magento2Api\Api\CheckoutGuestPaymentInformationManagementV1Api();
$cartId = "cartId_example"; // string | 
$body = new \TheCodeBunny\Magento2Api\Model\Body100(); // \TheCodeBunny\Magento2Api\Model\Body100 | 
...
------------- | ------------- | ------------- | -------------
 **cartId** | **string**|  |
 **body** | [**\TheCodeBunny\Magento2Api\Model\Body100**](../Model/\TheCodeBunny\Magento2Api\Model\Body100.md)|  | [optional]
...
$api_instance = new TheCodeBunny\Magento2Api\Api\CheckoutGuestPaymentInformationManagementV1Api();
$cartId = "cartId_example"; // string | 
$body = new \TheCodeBunny\Magento2Api\Model\Body101(); // \TheCodeBunny\Magento2Api\Model\Body101 | 
...
------------- | ------------- | ------------- | -------------
 **cartId** | **string**|  |
 **body** | [**\TheCodeBunny\Magento2Api\Model\Body101**](../Model/\TheCodeBunny\Magento2Api\Model\Body101.md)|  | [optional]
